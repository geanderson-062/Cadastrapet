...
<section class="container">
    ...
    <div class="card text-center container corPrimaria" style="max-width: 350px; border-radius: 5px;">
        ...
        <div class="card-body">
          ...
          <p class="fs-1 text-white text-center">Animais Cadastrados</p><br>
      
          <script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
          <lottie-player src="https://assets9.lottiefiles.com/packages/lf20_hjn3zzgy.json"  background="transparent"  speed="1"  loop  autoplay></lottie-player>
...
<table class="table bg-light">
  ...
  <thead>
    <tr>    
      ...
      <th scope="col">Endereço do Responsavel</th>
...
<div class="modal fade" id="confirmar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="../controller/excluir_pet.php" method="POST">
